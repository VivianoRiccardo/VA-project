...
export default class CustomScatter extends React.Component{
  ...
  handleDisplayFlagChange(click_type){
    ...
    let stellar_type = this.state.showed_star_type
    ...
    if (click_type === "startype") this.setState({showed_star_type:!stellar_type});
 ...
 handleConfirmChanges(){
  ...
  let distance = this.state.showed_pl_st_distance
  let type = this.state.showed_planet_type
  let star_types = this.state.showed_star_type
    ...
    <div>
            ...
            <div className="checkboxes">
              <label style = {{color:"white", font: "normal 18px sans-serif"}}>
                <input
                  type="checkbox"
                  name="planetTypeFlag"
                  checked={this.state.showed_star_type}
                  onChange={() => this.handleDisplayFlagChange("startype")}
                />
                Star Types
              </label>
            </div>
      ...
      <div>
        <CustomMatrix
          ...
          star_type_flag = {this.state.star_type}
